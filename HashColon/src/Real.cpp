...
namespace HashColon
{
	...
	long double operator "" _NM(long double NM) { return 1852.0 * NM; }		// Nautical Mile
	...
	long double operator "" _t(long double t) { return 1000.0 * t; }			// ton
	...
	long double operator "" _min(long double min) { return 60.0 * min; }			// minute
	long double operator "" _hr(long double hr) { return 3600.0 * hr; }			// hour
	long double operator "" _day(long double day) { return 24.0 * 3600 * day; }	// day

	// speed unit: m/s (meter per second)
	long double operator "" _kn(long double kn) { return 1852.0 / 3600.0 * kn; }			// knots = NM per hour
	long double operator "" _mph(long double mph) { return mph / 0.00062137 / 3600.0; }	// mph = mile per hour
	long double operator "" _kmph(long double kmph) { return 1000.0 / 3600.0 * kmph; }	// kmph = kilometer per hour

	// pressure unit: pascal(Pa) = N/m^2
	long double operator "" _Pa(long double Pa) { return Pa; }							// pascal 
	long double operator "" _kPa(long double kPa) { return 1000.0 * kPa; }				// kilo-pascal
	long double operator "" _bar(long double bar) { return 100.0 * 1000.0 * bar; }			// bar = 100 kPa
	long double operator "" _atm(long double atm) { return 101.325 * atm; }				// atmosphere
	long double operator "" _psi(long double psi) { return 6.894757 * 1000.0 * psi; }		// psi = pound per square inch
	long double operator "" _Torr(long double Torr) { return 101.325 / 760.0 * Torr; }	// Torr
	...
	long double operator "" _degF(long double degF) { return 5.0 / 9.0 * (degF - 32.0); }	// Fahrenheight degree
